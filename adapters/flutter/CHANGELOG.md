...
- Initial release: comparator replacement that captures goldens for the mitame binary, font loading, variant helpers, `MITAME_FONTS=ahem`, and identity collision detection.
